...
import { View, Text, StyleSheet, FlatList, Image, TouchableOpacity, ActivityIndicator, AsyncStorage } from 'react-native';
...
class Detail extends React.Component {
    ...
    async componentDidMount() {
        ...
        const response = await fetch(`https://hml-project.herokuapp.com/api/history/view/${token}`);
