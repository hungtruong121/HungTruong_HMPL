            ...
            <ScrollView>
                <View style={styles.account_container}>
                    <ImageBackground source={require('../../assets/bg8.jpg')} style={{ width: '100%', height: 180 }}>
                        <View style={styles.name_avt}>
                            <View style={styles.account_avt}>
                                <Image style={styles.img} source={require('../../assets/avt1.png')} />
                                <MaterialCommunityIcons name='check-decagram' size={23} style={styles.iconimg} />
                                <View style={styles.iconname}>
                                    <Text style={styles.name}>Xin chào, {username}</Text>
                                </View>
                            </View>
                        </View>
                    </ImageBackground>
                        ...
                        <View style={styles.choices}>
                            <TouchableOpacity style={styles.choice} onPress={() => navigate('Thay đổi mật khẩu')}>
                                <View style={styles.iconleft}>
                                    ...
                                    <Text style={styles.name_item}>Đổi mật khẩu</Text>
                                </View>
                                <AntDesign name='right' style={styles.icon_item} />
                            </TouchableOpacity>
                        </View>
                    ...
                    <View style={styles.btnlogout}>
                        <TouchableOpacity style={styles.button} onPress={() => {this._removeData(), this.props.navigation.dispatch(resetAction)}}>
