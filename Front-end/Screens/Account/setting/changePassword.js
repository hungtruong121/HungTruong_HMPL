...
export default class ChangePassword extends React.Component {
    ...
    getRemoteData = async() => {
        ...
        Axios.post(
            `https://hml-project.herokuapp.com/api/user/change?password=${password}&newpassword=${newpassword}&newconfirm=${newconfirm}&token=${token}`,
        )
            .then((res) => {
                        ...
                        <View style={styles.footer}>
                            ...
                            <View style={styles.action}>
                                <TextInput
                                    ...
                                    onChange={(input) =>
                                        this.setState({ newpassword: input.nativeEvent.text })
                                    }
                                />
                            ...
                            <View style={styles.action}>
                                <TextInput
                                    ...
                                    onChange={(input) =>
                                        this.setState({ newconfirm: input.nativeEvent.text })
                                    }
                                />
