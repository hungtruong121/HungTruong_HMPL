              ...
              <View style={styles.footer}>
                ...
                <TouchableOpacity onPress={() => this.getRemoteData()}>
                  <View style={styles.button_container}>
                    ...
                    >
                      {this.state.enable ? (
                        <Text style={styles.textLogin}>Đăng Nhập bằng FaceBook</Text>
                      ) : (
                          <Animatable.View animation1="bounceIn" delay={50}>
                            <FontAwesome name="check" color="white" size={20} />
                          </Animatable.View>
                        )}
                    </Animated.View>
                ...
                <TouchableOpacity onPress={() => this.getRemoteData()}>
                  <View style={styles.button_container}>
                    ...
                    >
                      {this.state.enable ? (
                        <Text style={styles.textLogin}>Đăng Nhập bằng Goo</Text>
                      ) : (
                          <Animatable.View animation1="bounceIn" delay={50}>
                            <FontAwesome name="check" color="white" size={20} />
                          </Animatable.View>
